...
// UPDATE DATA
	if (isset($_POST['update'])) 
	{
		...
		if($_POST['description'] and $_POST['city']=='')
		{
			echo ("<script>alert('Fill All The Field')</script>");
		}
		else
...
// DELETE DATA			
	if (isset($_POST['delete'])) 
	{
			...
			$query = "DELETE FROM detail WHERE city='$city'";
							...
							<div class="container" style="height: 100vh;">
								...
								<form action="#"  method="post"  enctype="multipart/form-data">
					                <div class="row" style="background: transparent;">
					                    <p style="color: white;">𝐒𝐭𝐚𝐭𝐞 𝐍𝐚𝐦𝐞:-</p>
					                     <input type="text" id="contactBlockPhone3" class="form-control" style="border-radius: 20px; color: white; background: transparent;" placeholder="Enter Your State" value="<?php echo @$ncity; ?>" name="city" />
					                </div>
					                <div class="row mt-5" style="background: transparent;">
					                    <p style="color: white;">𝐃𝐞𝐬𝐜𝐫𝐢𝐩𝐭𝐢𝐨𝐧:-</p>					            
					                    <textarea name="description" cols="100" rows="15" style="background: transparent ; border-radius:20px; color: white;"  autocomplete="off" class="form-control" /> <?php echo @$ndescription; ?></textarea>
					                </div>
						            <div class="row mt-5 text-center text-white mt-3"> 
						                <div class="col-sm-12 text-center text-white"><p>𝐂𝐡𝐨𝐨𝐬𝐞 𝐒𝐭𝐚𝐭𝐞 𝐏𝐡𝐨𝐭𝐨 <input type="file" name="image" value="choose file"> </p> </div> 
						            </div>
						            <div class="row mt-5">
						            	<div class="col-sm-3">
						            	<input type="submit" name="submit" value="𝐈𝐧𝐬𝐞𝐫𝐭 𝐓𝐨𝐮𝐫 𝐑𝐞𝐜𝐨𝐫𝐝" class="text-dark" style="border-radius: 10px;">
						          		</div>
						            	<div class="col-sm-3">
